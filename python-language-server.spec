...
Version  : 0.33.0
Release  : 5
URL      : https://files.pythonhosted.org/packages/ff/1a/26133f54c11619062b13c66c91dec4c5ff6af9058b634aafaeb841d3e41b/python-language-server-0.33.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/ff/1a/26133f54c11619062b13c66c91dec4c5ff6af9058b634aafaeb841d3e41b/python-language-server-0.33.0.tar.gz
...
%prep
%setup -q -n python-language-server-0.33.0
cd %{_builddir}/python-language-server-0.33.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590517862
...
cp %{_builddir}/python-language-server-0.33.0/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
