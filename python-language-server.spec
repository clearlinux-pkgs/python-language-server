...
Version  : 0.34.0
Release  : 9
URL      : https://files.pythonhosted.org/packages/33/5e/1e890e540a3b82e3a2621590e630fb5e8346ee0e1e763fd0ac011f6419e0/python-language-server-0.34.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/33/5e/1e890e540a3b82e3a2621590e630fb5e8346ee0e1e763fd0ac011f6419e0/python-language-server-0.34.0.tar.gz
...
%prep
%setup -q -n python-language-server-0.34.0
cd %{_builddir}/python-language-server-0.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593637912
...
cp %{_builddir}/python-language-server-0.34.0/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
