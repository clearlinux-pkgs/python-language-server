...
Version  : 0.33.3
Release  : 8
URL      : https://files.pythonhosted.org/packages/b6/98/6e88400758b3af07d29f5e1b175495e229284bdc9889d62a046c58efe1df/python-language-server-0.33.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/b6/98/6e88400758b3af07d29f5e1b175495e229284bdc9889d62a046c58efe1df/python-language-server-0.33.3.tar.gz
...
%prep
%setup -q -n python-language-server-0.33.3
cd %{_builddir}/python-language-server-0.33.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592866988
...
cp %{_builddir}/python-language-server-0.33.3/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
