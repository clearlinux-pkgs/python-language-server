...
Version  : 0.36.0
Release  : 15
URL      : https://files.pythonhosted.org/packages/32/fa/74ff26d9d4d0e8d39b89560ebb29b63d9747a6837d03f913330aa62dec9e/python-language-server-0.36.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/32/fa/74ff26d9d4d0e8d39b89560ebb29b63d9747a6837d03f913330aa62dec9e/python-language-server-0.36.0.tar.gz
...
%prep
%setup -q -n python-language-server-0.36.0
cd %{_builddir}/python-language-server-0.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604519038
...
cp %{_builddir}/python-language-server-0.36.0/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
