...
Version  : 0.33.1
Release  : 6
URL      : https://files.pythonhosted.org/packages/31/dc/5929418a005f126b4f936d431d50f5648a2d93b8a80502b660d6db083d0b/python-language-server-0.33.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/31/dc/5929418a005f126b4f936d431d50f5648a2d93b8a80502b660d6db083d0b/python-language-server-0.33.1.tar.gz
...
%prep
%setup -q -n python-language-server-0.33.1
cd %{_builddir}/python-language-server-0.33.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591289115
...
cp %{_builddir}/python-language-server-0.33.1/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
