...
Version  : 0.33.2
Release  : 7
URL      : https://files.pythonhosted.org/packages/b3/86/86436d88491d44fa0b70c76d7c13f54252c2e95d1513e612446d19b96bc3/python-language-server-0.33.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/b3/86/86436d88491d44fa0b70c76d7c13f54252c2e95d1513e612446d19b96bc3/python-language-server-0.33.2.tar.gz
...
%prep
%setup -q -n python-language-server-0.33.2
cd %{_builddir}/python-language-server-0.33.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592585685
...
cp %{_builddir}/python-language-server-0.33.2/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
