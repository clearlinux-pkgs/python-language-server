...
Source0  : https://files.pythonhosted.org/packages/5b/d2/9a2c8fbafad6fc0e8cfc110010512a2248a773f7e94573ed7899d2b8034a/python-language-server-0.34.1.tar.gz
...
%prep
%setup -q -n python-language-server-0.34.1
cd %{_builddir}/python-language-server-0.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593712818
...
cp %{_builddir}/python-language-server-0.34.1/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
