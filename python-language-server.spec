...
Version  : 0.31.9
Release  : 2
URL      : https://files.pythonhosted.org/packages/d1/22/a64512fe2e12030e3f5535a6859cdc271262afd7ffb93cec36f1b91da07f/python-language-server-0.31.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/d1/22/a64512fe2e12030e3f5535a6859cdc271262afd7ffb93cec36f1b91da07f/python-language-server-0.31.9.tar.gz
...
%prep
%setup -q -n python-language-server-0.31.9
cd %{_builddir}/python-language-server-0.31.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584592885
...
cp %{_builddir}/python-language-server-0.31.9/LICENSE %{buildroot}/usr/share/package-licenses/python-language-server/4df3c87108ebab83aa7bb222e245d841c6574d4f
